...
public class class_linck {
    ...
    static final String URL_Bible = "http://www.jw.org/download/?output=html&pub=bi12&fileformat=EPUB&alllangs=0&langwritten=%s&txtCMSLang=%s&isBible=1";

    //
    // http://www.jw.org/download/?output=html&pub=bi12&fileformat=EPUB&alllangs=0&langwritten=E&txtCMSLang=E&isBible=1
    ...
    // http://www.jw.org/apps/E_TRGCHlZRQVNYVrXF?fileformat=EPUB&output=html&pub=nwt&langwritten=U
